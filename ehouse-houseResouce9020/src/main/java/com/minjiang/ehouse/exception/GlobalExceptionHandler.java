...
public class GlobalExceptionHandler {
    ...
    public Result bizExceptionHandler(HttpServletRequest req, BizException e){
        ...
        return new Result(Integer.parseInt(e.getErrorCode()),e.getErrorMsg(),false);
    }
    ...
    @ResponseBody
    public Result ioexceptionHandler(HttpServletRequest req, IOException e){
        logger.error("文件流传输异常！原因是:",e);
        return new Result(500,"文件流传输异常",false);
    }
}